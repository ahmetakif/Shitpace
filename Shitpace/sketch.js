...
function draw() {
  ...
  if (mouseIsPressed) {
    if (mouseX < uparrowx+arrowdx && mouseX > uparrowx && mouseY < uparrowy+arrowdy && mouseY > uparrowy) {
      ship.move(0, -10);
    }
    if (mouseX < downarrowx+arrowdx && mouseX > downarrowx && mouseY < downarrowy+arrowdy && mouseY > downarrowy) {
      ship.move(0, 10);
    }
    if (mouseX < leftarrowx+arrowdx && mouseX > leftarrowx && mouseY < leftarrowy+arrowdy && mouseY > leftarrowy) {
      ship.move(-10, 0);
    }
    if (mouseX < rightarrowx+arrowdx && mouseX > rightarrowx && mouseY < rightarrowy+arrowdy && mouseY > rightarrowy) {
      ship.move(10, 0);
    }
  }
